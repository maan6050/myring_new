			...
			<tbody><?
				if($latest)
				{
					...
					<tr>
						...
						<td class="actionsTd"><a href="<?= base_url('seller/transactionsList'); ?>">See all</a></td>
					</tr><?
				} ?>
				<tr>
					<td>Number of registered stores: <strong><?= $stores; ?></strong>.</td>
					<td class="actionsTd"><a href="<?= base_url('seller/storesList'); ?>">See all</a></td>
				</tr>
				<tr>
					<td colspan="2">My stores total due: <strong>$<?= $sumBalances; ?></strong>.</td>
				</tr>
				<tr>
