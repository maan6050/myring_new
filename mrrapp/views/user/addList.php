<?php
    ...
    if(isset($_GET["userid"])){ 
        $action = base_url('User/userformUpdate');
    } else {
        $action = base_url('User/userformSubmit');
    }
    //echo"<pre>";
    //print_r($users);
    //die();
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="v_enabled" id="v_enabled" title="Please select your status." required="yes" aria-describedby="ui-tooltip-0">
                                    <option value="1" <?php if(isset($_GET["userid"])) { if($customers[0]->ENABLED==1){ echo "selected"; } } ?>>Enabled</option>
                                    <option value="0" <?php if(isset($_GET["userid"])) { if($customers[0]->ENABLED==0){ echo "selected"; } } ?>>Disabled</option> 
                                </select>
                            </div>
                        </div>        
                    </div> <?php
                ...
                <div class="row"> 
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="f_name" id="f_name" value="<? if(isset($_GET["userid"])){ echo $users[0]->FIRST_NAME; } ?>" title="Please fill in your First name." required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label for="l_name">Last Name</label>
                            <input type="text" class="form-control" name="l_name" id="l_name" value="<? if(isset($_GET["userid"])){ echo $users[0]->LAST_NAME; } ?>" title="Please fill in your last name." required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label for="v_fax">Work Phone No.</label>
                            <input type="number" name="v_fax" id="v_fax" value="<? if(isset($_GET["userid"])){ echo $users[0]->FAX; } ?>" class="form-control"  pattern="[0-9]{5,}" onkeypress="isNNumeric(event)" title="" aria-describedby="ui-tooltip-13" title="Please fill in Work Phone number." required>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="v_phone"  id="v_phone" value="<? if(isset($_GET["userid"])){ echo $users[0]->LOCAL_PHONE; } ?>" class="form-control"  pattern="[0-9]{5,}" onkeypress="isNNumeric(event)" title="" aria-describedby="ui-tooltip-13" title="Should be Numeric." required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                        <div class="form-group">
                            <label for="v_email">Email Address</label>
                            <input type="email" class="form-control" value="<? if(isset($_GET["userid"])){ echo $users[0]->E_MAIL; } ?>" name="v_email"  id="v_email" pattern="(([^<>()[\]\\.,;:\s@\&quot;]+(\.[^<>()[\]\\.,;:\s@\&quot;]+)*)|(\&quot;.+\&quot;))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))" message="Not a valid email address." required>
                        </div>
                    
                        <div class="form-group">
                            <label for="tax_id">Tax ID</label>        
                            <input type="text" value="<? if(isset($_GET["userid"])) { echo $users[0]->USER_4; } ?>" class="form-control" name="tax_id"  id="tax_id" title="Please fill in Tax ID field." aria-describedby="ui-tooltip-37" required>
                            
                        </div>
                    
                        <div class="form-group">
                            <label for="f_company">Company Name</label>
                            <input type="text" class="form-control" name="f_company" id="f_company" value="<? if(isset($_GET["userid"])) { echo $users[0]->COMPANY; } ?>" title="Please fill in your Store name." required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="v_question" id="v_question" title="Please select your security Question." required="yes" aria-describedby="ui-tooltip-0">
                                ...
                                foreach($security_questions as $question_key => $question_value) { ?>
                                    <option value="<?php echo $question_key;?>" <?php if(isset($_GET["userid"])) { if($users[0]->USER_2==$question_key){ echo "selected"; } } ?>><?php echo $question_value; ?></option> <?
                                }?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="v_answer">Security Answer is:</label>
                            <input type="text" class="form-control" name="v_answer" id="v_answer" value="<? if(isset($_GET["userid"])) { echo $users[0]->USER_3; } ?>" title="Please answer your security Question." required>
                        </div>
                    </div>  
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="plan_prod" id="plan_prod" title="Please Select Product Plan." required="yes">
                                ...
                                foreach($plan_prod as $plan_prod_key => $plan_prod_value) { ?>
                                    <option value="<?php echo $plan_prod_key;?>" <?php if(isset($_GET["userid"])) { if($users[0]->USER_6==$plan_prod_key){ echo "selected"; } } ?>><?php echo $plan_prod_value; ?></option> <?
                                }?>
                            </select>
                        </div>
                    </div>
            ...
            <div class="row">  
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<? if(isset($_GET["userid"])) { echo $users[0]->ADDRESS1; } ?>" name="v_address1">
                    </div>
                    <div class="form-group">
                        <label for="v_cty">City</label>
                        <input type="text" class="form-control" value="<? if(isset($_GET["userid"])) { echo $users[0]->CITY; } ?>" name="v_cty">
                    </div>
                    <div class="form-group">
                        <label for="v_zip">Zip Code</label>
                        <input type="text" class="form-control" value="<? if(isset($_GET["userid"])) { echo $users[0]->POSTAL_CODE; } ?>" name="v_zip">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="v_suite" value="<? if(isset($_GET["userid"])) { echo $users[0]->ADDRESS2; } ?>">
                    </div>
                    <div class="form-group">
                        <label for="v_state">State/ Province</label>
                        <input type="text" class="form-control" name="v_state" value="<? if(isset($_GET["userid"])) { echo $users[0]->STATE_REGION; } ?>">
                    </div>
                    <div class="form-group">
                        ...
                        <select name="v_country" class="form-control" id="v_country"  required="yes">
                            ...
                            foreach($countries as $countries_key => $countries_value) { ?>
                                <option value="<?php echo $countries_key;?>" <?php if(isset($_GET["userid"])) { if($users[0]->COUNTRY==$countries_key){ echo "selected"; } } ?>><?php echo $countries_value; ?></option> <?
                            }?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="latitude" value="<? if(isset($_GET["userid"])) { echo $customers[0]->USER_7; } ?>" onkeypress="isNFloat(event)">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="longitude" value="<? if(isset($_GET["userid"])) { echo $customers[0]->USER_8; } ?>" onkeypress="isNFloat(event)">
                    </div>
                </div>
            </div>
